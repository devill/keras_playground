...
model = getModel()
opt = Nadam(lr=0.001, beta_1=0.9, beta_2=0.999, epsilon=1e-08, schedule_decay=0.006)
...
for i in range(3,7):
    ...
    model.save_weights('/data/trained_models/mnist/v1_e'+ensamble_idx+'.'+str(i)+'_'+stats+'.h5')
